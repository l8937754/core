...
<%--    <table class="layui-table" url="${pageContext.request.contextPath}/findClassStudentlist" id="tb">
        <thead>
        <tr>
            <th lay-data="{field:c_classid}">班级编号</th>
            <th lay-data="{field:c_classname}">班级名</th>
            <th lay-data="{field:c_counsellor}">辅导员</th>
            <th lay-data="{field:s_studentid}">学生学号</th>
            <th lay-data="{field:s_name}">学生姓名</th>
            <th lay-data="{field:s_phone}">电话</th>
            <th lay-data="{field:s_dormitoryid}">宿舍编号</th>
        </thead>
</table>    --%>     
</div>
